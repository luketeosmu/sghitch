<template lang="">
    ...
    <div class="drawer-content flex flex-col pb-10">
        ...
        <div class="flex justify-center items-center text-center mb-5 px-2 sm:px-0">
        ...
        <!-- <span class="justify-center items-center font-bold text-3xl font-sans mt-5 pb-5 px-3 pb-3 bg-white text-center text-black"> Current Favourites </span> -->
          <div class="flex items-center justify-center text-xs sm:text-base w-[350px] sm:w-[600px] mx-auto sm:px-0">
              ...
              <table v-if="myRequest.length != 0" class="table table-compact sm:table-normal sm:w-full z-0 ">
                  <thead>
                  <tr >
                      <th class="bg-slate-300 bg-opacity-95">Date</th>
                      <th class="bg-slate-300 bg-opacity-95">Time</th>
                  ...
                  <tr v-for="request in myRequest" :id="request.rid">
                      <td class="bg-opacity-95">{{ request.datetime.split("T")[0] }}</td>
                      <td class="bg-opacity-95">{{ setTimeStr(request.datetime.split("T")[1]) }}</td>
