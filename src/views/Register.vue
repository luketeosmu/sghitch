<template>
    <div class="h-screen flex grid grid-cols-1 sm:grid-cols-2">
        <div class="absolute z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  ">
            <div class="card w-96 p-12 bg-white bg-opacity-30">
            <form>
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                    ...
                    <input @keyup.enter='register()' v-model.lazy="input.password" class="pl-2 outline-none border-none bg-inherit font-medium" type="password" name="" placeholder="Password" />
                </div>
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="black">
                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                    </svg>
                    <input @keyup.enter='register()' v-model.lazy="input.confirmPassword" class="pl-2 outline-none border-none bg-inherit font-medium" type="password" name="" placeholder="Confirm Password" />
                </div>
                ...
                <button @click='register()' type="button" class="block w-full bg-black bg-opacity-70 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Sign up</button>
                <span @click='login()' class="text-sm ml-2 hover:text-white cursor-pointer text-black">Already have an account? Login here </span> <br><br>
            </form>
            <p class="text-center mt-4 text-sm text-black">By clicking on "Sign up" you agree to <br>
                <a class="underline text-black visited:text-indigo-700" href="#">Terms of Service</a> | <a class="underline text-black visited:text-indigo-700" href="#"> Privacy Policy </a>
            </p>
        </div>
        </div>
        </div>
