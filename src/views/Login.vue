        ...
        <div class="relative z-30 flex justify-center items-end sm:items-center bg-white-100/20">
            <div v-if="!readMore" class="animate__bouluke.teo.2020@scis.smu.edu.sgnceIn">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-1">
                    ...
                    <div>
                        <button @click="toggleReadMore()" type="submit" class="block w-28 bg-white bg-opacity-60 text-black py-1 rounded-2xl font-bold ml-4 sm:m-4 sm:py-2">Read More</button>
                    </div>
                </div>
            </div>
        ...
        <div class="relative z-30 flex justify-center items-start py-10 sm:items-center bg-white-100/20 mt:5">
            ...
            <form>
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                    ...
                    <input @keyup.enter='login()' v-model.lazy="input.email" class="pl-2 outline-none border-none bg-inherit font-medium" type="email" name="" placeholder="Email Address" />
                </div>
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl border-black">
                    ...
                    <input @keyup.enter='login()' v-model.lazy="input.password" class="pl-2 outline-none border-none bg-inherit font-medium" type="password" name="" placeholder="Password" />
                </div>
                <div>
                    <p v-if="errMsg" className="mt-2 text-red-500">{{ errMsg }}</p>
                </div>
                <button @click='login()' type="button" class="block w-full bg-black bg-opacity-70 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Sign in</button>
            ...
            <p class="text-center mt-4 text-sm text-white">By clicking on "Sign in" you agree to <br>
                <a class="underline text-white visited:text-indigo-700" href="#">Terms of Service</a> | <a class="underline text-white visited:text-indigo-700" href="#"> Privacy Policy </a>
            </p>
        </div>
        </div>
