<template>
    <div class="h-screen flex grid grid-cols-1 sm:grid-cols-2">
        <div class="relative z-30 flex justify-center items-end sm:items-center bg-white-100/20">
            <div v-if="!readMore" class="animate__animated animate__fadeIn">
            ...
            <div v-else class="animate__animated animate__fadeIn">
                ...
                <p class="text-black mt-1 bg-yellow-50 p-2 rounded-2xl mb-4 border-gray-500 font-sans sm:bg-inherit sm:text-white">We serve as a platform to connect hitchers and drivers.<br> We aim to provide you an affordable ride to your destinations <br> and to also help drivers save on fuel costs.</p>
