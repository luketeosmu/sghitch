                        ...
                        <div class='flex flex-wrap -mx-3 mb-6'>
                            ...
                            <div class="flex items-center justify-between mt-4">
                                <div class='w-full md:w-1/2 px-3 mb-6'>
                                    <label class='text-black text-xl mb-2' >First Name</label>
                                ...
                                <div class='w-full md:w-1/2 px-3 mb-6'>
                                    <label class='text-black text-xl mb-2' >Last Name</label>
                                    <input class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' type='text'  required>
                                </div>
                            </div>
                        
                            <div class='w-full md:w-full px-3 mb-6'>
                                <label class='text-black text-xl mb-2' for='grid-text-1'>Current Password</label>
                            ...
                            <div class="personal w-full border-t border-gray-400 pt-4">
                                ...
                                <div class='w-full md:w-full px-3 mt-6'>
                                    ...
                                    <span @click='' class="flex justify-end text-sm mt-2 text-black hover:text-black cursor-pointer">Forgot your password? </span>
                                </div>
                                <div class='w-full md:w-full px-3 mb-6'>
