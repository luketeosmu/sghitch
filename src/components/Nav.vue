<template lang="">
    <div class="navbar sticky top-0 z-10 absolute bg-yellow-300 mb-5">
        ...
        <div class="navbar-center">
            ...
            <div v-if="this.user.type == 'driver'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 mx-2">
        ...
        <div class="navbar-end">
            <button @click='newReq()' type="button" class="btn btn-ghost block p-1 md:p-3 rounded-2xl text-black font-semibold" to="newReq">New Request</button>
            ...
            <div class="dropdown dropdown-end mr-3 hidden md:block">
                <label tabindex="0" class="md:flex btn btn-ghost p-3 rounded-2xl text-black font-semibold px-1 ml-3">My Account &nbsp<i class="bi bi-caret-down-fill"></i></label>
